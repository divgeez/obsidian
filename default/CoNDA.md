# (2023/11/14, Research) _CoNDA: Efficient Cache Coherence Support for Near-Data Accelerators_

_Reporter: [올만구스타프 / GSP & System반도체 T/F(SAIT)](https://confluence.samsungds.net/display/~a.gustav)_ 

This previous work is trying to find a solution of how to implement a coherence protocol between CPUs and near-data accelerators (NDA) without significant overhead of keeping each device coherent. They argue that the high-communication cost between CPU and NDA with existing coherence protocols eliminate most of the benefits of using an NDA in the first place and a better approach is needed. They suggest a new approach that they call "CoNDA", that optimistically execute NDA kernels and gather information of which memory accesses performed by the NDA to avoid unnecessary coherence requests to reduce overhead.
...
[Relevant News, Research and Other Materials - SAIT-SoC - DS Confluence (samsungds.net)](https://confluence.samsungds.net/display/SAITSoC/Relevant+News%2C+Research+and+Other+Materials#)

[  
Computer Architecture - Lecture 19: Cache Coherence (Fall 2022) @ 2:14:42](https://youtu.be/aFRboAI_3RU?t=8082)

**The full paper can be found here:**

[CoNDA: Efficient Cache Coherence Support for Near-Data Accelerators | IEEE Conference Publication | IEEE Xplore](https://ieeexplore.ieee.org/document/8980366)